          ...
          <ul className="menu p-4 w-80 bg-[#D1A054] text-base-content">
           {
            ...
            <li>
            <NavLink to='admin'> <FaHome></FaHome>Admin Home </NavLink>
            </li>
            <li>
              <NavLink to='/'> <FaUtensils></FaUtensils>  Add Items</NavLink>
            </li>
            <li>
              <NavLink to='/'> <FaWallet></FaWallet> Manage items</NavLink>
            </li>
            <li>
              <NavLink to='manageItem'> <FaBook></FaBook> Manage bookings</NavLink>
            </li>
            <li>
              <NavLink to='users'> <FaUsers></FaUsers> All users</NavLink>
            </li>

            </> : <>

            <li>
            <NavLink to='admin'><FaHome></FaHome>User Home </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink to='/'><FaBars></FaBars>  Menu</NavLink>
            </li>
            <li>
              <NavLink to='/'> <FaShoppingBag></FaShoppingBag> Shop</NavLink>
            </li>
            <li>
